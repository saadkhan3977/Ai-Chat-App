                            ...
                            <div class="col-lg-12">
                                <div class="card card-bordered" style="width:400px">
                                    <div class="card-header">
                                        <h4 class="card-title"><strong>Image Generate</strong></h4>
                                    ...
                                    <div class="publisher bt-1 border-light">
                                        ...
                                        <input class="publisher-input" type="text" id="msg" placeholder="Search For Image">
                                        <a class="publisher-btn" href="#" data-abc="true"><i class="fa fa-smile"></i></a>
                                        <a class="publisher-btn text-info" href="javascript:;" onclick="generate_image()" data-abc="true">send</a>
                                    </div>
                                </div>
                            </div>
                        </div>
